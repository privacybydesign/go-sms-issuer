        ...
        resources: {
            en: {
                translation: {
                    ...
                    index_phone_not_valid: "The entered phone number is not valid yet.",
                    index_phone_valid: "The entered phone number is valid.",
            ...
            nl: {
                translation: {
                    ...
                    index_phone_placeholder: "06 12345678",
                    index_phone_not_valid: "Het ingevoerde telefoonnummer is nog niet geldig.",
                    index_phone_valid: "Het ingevoerde telefoonnummer is geldig.",
